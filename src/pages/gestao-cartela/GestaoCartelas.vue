...
import GestaoCartelasCreatEditDialog from '../../components/dialog/GestaoCartelasCreatEditDialog.vue';
import GestaoCartelasViewDialog from '../../components/dialog/GestaoCartelasViewDialog.vue';
